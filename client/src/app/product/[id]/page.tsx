      ...
      <div className="min-h-screen pt-30 bg-gradient-to-b from-black via-gray-900 to-gray-950 text-white flex items-center justify-center">
        <div className="text-center max-w-md mx-auto p-6 bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl">
          ...
          <p className="text-gray-300">
            {error || "This NFT does not exist or could not be loaded."}
          </p>
        </div>
      </div>
    );
      ...
      <header className="py-6 px-4 sm:px-6 lg:px-8 border-b border-white/10">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-gray-400">
            Discover, collect, and authenticate luxury items
          </p>
        </div>
      </header>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6 mt-4 shadow-lg space-y-4">
              ...
              {nft.Payment &&
              Object.keys(nft.Payment).filter((key) => key !== "_id").length >
                0 ? (
  ...
  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm">
    <div className="bg-gray-900 border border-white/10 rounded-2xl p-0 max-w-md w-full shadow-2xl">
      ...
      <div className="p-6">
        ...
        <div className="mb-6">
          ...
          <p className="text-xs text-gray-400 mt-2">
            Approving will transfer the NFT to this address
          </p>
        </div>
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-xs text-gray-300 mt-1">
                You are confirming that payment for this NFT has been received and verified.
                Upon approval, ownership will be transferred to the requester.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="p-4 border-t border-white/10 flex justify-between">
        ...
        {/* Reject Payment Modal */}{showRejectPaymentModal && (
  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm">
  <div className="bg-gray-900 border border-white/10 rounded-2xl p-0 max-w-md w-full shadow-2xl">
    {/* Header */}
    <div className="p-6 border-b border-white/10 flex justify-between items-center">
    ...
    <div className="p-6">
      ...
      <div className="mb-6">
        ...
        <p className="text-xs text-gray-400 mt-2">
          Payment request from this address will be rejected
        </p>
      </div>
      ...
      <div className="bg-red-500/10 border border-red-500/20 rounded-lg p-4 mb-6">
        <div className="flex items-start">
          ...
          <div>
            ...
            <p className="text-xs text-gray-300 mt-1">
              Are you sure you want to reject this payment request? The NFT will remain in your ownership and the requester will be notified.
            </p>
          </div>
        </div>
      </div>
